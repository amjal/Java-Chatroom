...
/**
 * Two main duties of the class are handling user input and displaying proper output for the user
 * It does so with the help of its two threads called ConsoleReader and ConsoleWriter
 */
public class UserHandler{
    protected boolean loggedIn = false;
    ServiceStopListener ssl;//this is NetworkHandler class
    ...
    /**
     *Method below is actually only used by ConsoleReader class. It handles plain user input by
     * getting it as a string and returns the derivative Message. It does it by the means of regex
     * which makes the code easy to read and simpler
     */
    //TODO cancelling invitations and reconnecting to different IPs or ports
    ...
    /**
     * This thread reads the input, gets the Message generated by method interpret(), and after
     * doing proper setup, puts it in the sending queue. note the if(!go) conditions, these are
     * for the disconnection stage
     */
    ...
    /**
     * The ConsoleWriter class, embeds a thread, which reads received messages and generates
     * decent user output. Whatever the server sends, must be interpreted and just printed to
     * the console the server doesn't send requests to clients. only information.
     */
